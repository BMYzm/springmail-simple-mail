...
public class Test1 {
	...
	/**
	 * 	下面是使用Spring容器发送的测试
	 * 		-注意这只是测试，项目不要这样用，项目中可以使用spring子容器的方式来加载mail
	...
	public void testSendWithSpring() throws MailAddressException {
		ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext("classpath:spring-mailx.xml");
